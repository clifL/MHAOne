...
var vacTag = "<span id = 'appointmentType'>Appointment Type (*)</span><select name='ddlSelect' id='subType' class='shadow-sm form-control'>" +
    "<option id = 'defaultType'>Please Select an Option</option><option>Hepatitis A</option>" +
...
var consultTag = "<span id = 'appointmentType'>Appointment Type (*)</span><select name='ddlSelect' id='subType' class='shadow-sm form-control'>" +
    "<option id = 'defaultType'>Please Select an Option</option><option>Health Screening</option>" +
...
function submitForm() {
    document.getElementById("appointmentType").style.color = "black";
    ...
    if ($('#subType option:selected').text() == "Please Select an Option") {
        ...
        document.getElementById("appointmentType").style.color = "#dc3545";
        return;
    }
    else if (document.getElementById("date").value == "") {
        alert("Please select a date");
        document.getElementById("dateLabel").style.color = "#dc3545";
        return;
    }
    else if (document.getElementById("time").value == "") {
        alert("Please select a timeslot");
        document.getElementById("timeLabel").style.color = "#dc3545";
        return;
    }
    ...
    sessionStorage.removeItem("amend")
